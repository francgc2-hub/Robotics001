...
T01 = T.subs({d: 0.352, a: 0.07, alpha: sp.pi/2})
T01 = T01.subs(theta, theta_1)
sp.pprint(T01)

T12 = T.subs({d: 0, a: 0.36, alpha: 0})
T12 = T12.subs({theta: theta_2})
sp.pprint(T12)

T23 = T.subs({d: 0, a: 0, alpha: sp.pi/2})
T23 = T23.subs({theta: theta_3})
sp.pprint(T23)

T34 = T.subs({d: 0.380, a: 0, alpha: -sp.pi/2})
...
T56 = T.subs({d: 0.065, a: 0, alpha: 0})
